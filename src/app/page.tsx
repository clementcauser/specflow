...
const SECTIONS: Section[] = [
  {
    ...
    desc: "3-4 phrases professionnelles qui posent le contexte. Parfait pour le brief client.",
    tag: "toujours inclus",
  },
  {
    icon: "👤",
    title: "Personas",
    desc: "Identifiés automatiquement depuis la description, avec besoins et points de friction.",
    tag: "contextuel",
  },
  {
    icon: "📝",
    title: "User stories MoSCoW",
    desc: "Toutes les stories priorisées MUST / SHOULD / COULD / WON’T. Prêtes pour le sprint.",
    tag: "priorisé",
  },
  {
    icon: "✅",
    title: "Critères Gherkin",
    desc: "Given / When / Then pour chaque story. Directement utilisables pour les tests.",
    tag: "format standard",
  },
  {
    icon: "🚫",
    title: "Hors-périmètre",
    desc: "Ce qui n’est explicitement pas dans le scope. Évite les malentendus en fin de projet.",
    tag: "contractuel",
  },
  {
    icon: "❓",
    title: "Questions de clarification",
    desc: "Les points ambigus détectés par l’IA, avec l’impact sur la spec si non répondus.",
    tag: "actionnable",
  },
];
...
const jsonLd = {
  ...
  offers: [
    ...
    },
    {
      ...
      priceCurrency: "EUR",
      description:
        "Specs illimitées, membres illimités, templates personnalisés",
    },
  ],
  featureList: [
    "User stories MoSCoW",
                  ...
                  {[
                    {
                      ...
                      text: "En tant qu'acheteur, je peux filtrer les produits par taille et couleur",
                    },
                    {
                      p: "MUST",
                      c: "bg-green-100 text-green-700",
                      text: "En tant qu'acheteur, je peux ajouter un produit au panier depuis la fiche",
                    },
                    {
                      p: "SHOULD",
                      c: "bg-primary/10 text-primary",
                      text: "En tant qu'acheteur, je reçois une confirmation par email après commande",
                    },
                    {
                      p: "COULD",
                      c: "bg-amber-100 text-amber-700",
                      text: "En tant qu'acheteur, je peux sauvegarder une wishlist et la partager",
                    },
                  ].map((us, i) => (
                    <li key={i} className="flex items-start gap-2 text-xs">
                      <span
                        className={`mt-0.5 shrink-0 rounded px-1.5 py-0.5 text-[10px] font-semibold ${us.c}`}
                      >
                        {us.p}
                      </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[200px_1fr]">
              ...
              <div className="hidden md:block border-r border-border py-3">
                {[
                  ...
                  >
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${i === 3 ? "bg-primary" : "bg-border"}`}
                    />
                    {item}
                  </div>
                ))}
              ...
              <div className="p-6 font-mono text-xs leading-relaxed overflow-x-auto">
                ...
                <div className="rounded-lg bg-muted/40 border border-border p-4 space-y-1">
                  <p>
                    <span className="text-pink-500 font-medium">Feature:</span>{" "}
                    <span className="text-foreground">Ajout au panier</span>
                  </p>
                  <p className="pt-1">
                  ...
                  <p className="pl-4">
                    ...
                    <span className="text-muted-foreground">
                      le produit apparaît dans mon panier
                    </span>
                  </p>
                  <p className="pl-4">
                ...
                <ul className="space-y-0 mb-8 divide-y divide-border">
                  {plan.features.map((f, j) => (
                    ...
                    >
                      <span
                        className={
                          f.ok ? "text-green-600" : "text-muted-foreground/40"
                        }
                      >
                        {f.ok ? "✓" : "✗"}
                      </span>
